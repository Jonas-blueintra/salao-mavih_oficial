                ...
                <form id="formPerfil" action="<?= base_url('cliente/perfil/salvar') ?>" method="post"
                    ...
                    <div class="profile-card">
                        ...
                        <div class="text-center mb-4">
                            <img src="<?= base_url('uploads/usuarios/' . $usuario->data->foto) ?>"
                                class="profile-img mb-3">

                            <div class="text-center mb-3">

                                <label for="uploadFoto"
                                    class="btn btn-outline-pink px-4 py-2 rounded-pill shadow-sm upload-btn">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="sexo" class="form-control">
                                    <option value="m" <?= $usuario->data->sexo == 'm' ? 'selected' : '' ?>>Masculino
                                    </option>
                                    <option value="f" <?= $usuario->data->sexo == 'f' ? 'selected' : '' ?>>Feminino
                                    </option>
                                </select>
                            </div>
