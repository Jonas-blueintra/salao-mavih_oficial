...
<head>
    ...
    .service-card {
        ...
        box-shadow: 0 10px 28px var(--blue);
        height: 100%;
        display: flex;
    ...
    .badge-time {
        background: linear-gradient(135deg, var(--cor-bg));
        color: var(--texto);
        font-weight: 500;
        border-radius: 20px;
        font-size: .9rem;
    ...
    .service-card p.text-muted {
        color: var(var(--texto-suave)) !important;
        font-size: .95rem;
    }

    .service-card .btn {
        background: linear-gradient(135deg, var(--cor-bg), var(--cor-bg));
        border: none;
        color: #fff;
        font-weight: 600;
        padding: 12px;
