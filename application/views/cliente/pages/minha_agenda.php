...
<head>
    ...
    <head>
        ...
        .agenda-img {
            ...
            height: 570px;
            object-fit: cover;
            border-bottom: 4px solid var(--cor-bg);
        }
    ...
    <div class="container  body-offset">
        <div class="agenda-header text-center mb-5 position-relative">
            ...
            <p class="text-muted mb-3">
                Aqui você acompanha todos os seus horários, cortes e atendimentos, organizados pra manter seu dia sempre
                no estilo. 🔥
            </p>
            ...
            <div class="agenda-card">
                ...
                <div class="p-4 agenda-info">
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-3">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1"><?= $agenda->servico ?></h5>

                            <div class="mb-1">
                                <i class="bi bi-calendar-heart" style="color:var(--blue)"></i>
                            ...
                            <div class="mb-1">
                                <i class="bi bi-hourglass-split" style="color:var(--blue)"></i>
                                Duração: <strong><?= $servico->data->duracao ?> min</strong>
                            </div>

                            <div class="mb-2">
                                <i class="bi bi-cash-coin" style="color:var(--blue)"></i>
                    ...
                    <button class="btn  w-100 btn-cancelar" onclick="cancelarAgenda(<?= $agenda->id ?>)">
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    ...
                    if (resMotivo.isConfirmed) {
                        ...
                        const quem = 'cliente';
                        fetch(
                                `<?= base_url('cliente/agendar/cancelar_agenda') ?>/${id}?motivo=${motivo}&quem_cancelou=${quem}`
                            )
