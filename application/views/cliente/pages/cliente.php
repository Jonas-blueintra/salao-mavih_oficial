...
.hero .btn:hover {
    ...
    box-shadow: 0 15px 40px rgba(255,79,139,.45);
} */
        .hero {
            position: relative;
            height: 100vh;
        ...
        .card {
            border: none;
            border-radius: 22px;
            box-shadow: 0 15px 40px rgba(255, 79, 139, .15);
            transition: all .4s ease;
        }
        ...
        .carousel-inner {
            border-radius: 25px;
            overflow: hidden;
            box-shadow: 0 20px 50px rgba(255, 79, 139, .3);
        }
        ...
        #equipe img {
            ...
            box-shadow: 0 10px 30px rgba(255, 79, 139, .4);
        ...
        .btn-avaliar {
            background: linear-gradient(135deg, #ff6fa4, #b02a6b);
            color: #fff;
            font-weight: 600;
            padding: 12px;
            border-radius: 999px;
        ...
        .avaliacao-avatar {
            ...
            box-shadow: 0 4px 12px rgba(255, 111, 145, .4);
        }
        ...
        .avaliacao-card {
            ...
            border-radius: 28px;
            padding: 26px;
            box-shadow: 0 12px 30px rgba(176, 42, 107, .18);
        ...
        .avaliacao-card {
            ...
            border-radius: 28px;
            padding: 28px;
            box-shadow: 0 20px 45px rgba(176, 42, 107, 0.18);
            border: 1px solid #f4c2d7;
        ...
        .avaliacao-card:hover {
            transform: translateY(-8px);
            box-shadow: 0 32px 70px rgba(176, 42, 107, 0.3);
        }
        ...
        .star.filled {
            color: #ff6f91;
            text-shadow: 0 2px 6px rgba(255, 111, 145, 0.6);
        }
        ...
        .sobre-nos-btn {
            ...
            background: linear-gradient(135deg, var(--rosa-principal), var(--rosa-claro));
            border: none;
            box-shadow: 0 8px 20px rgba(255, 79, 139, 0.25);
            transition: box-shadow 0.3s ease, transform 0.3s ease;
        }

        .sobre-nos-btn:hover {
            box-shadow: 0 12px 30px rgba(255, 79, 139, 0.4);
            transform: translateY(-4px);
        }
        ...
        .hero-content h1 {
            ...
            color: var(--rosa-principal);
            text-shadow: 0 4px 10px rgba(176, 42, 107, 0.35);
...
<body class="body_cliente_home">
    ...
    <section id="sobre-nos" class="container py-5">
        <h2 class="text-center fw-bold mb-5 fade-up">Salão Mavih</h2>
        <div class="row align-items-center gy-4">
            ...
            <div class="col-lg-6 fade-up">
                <h3 class="fw-bold mb-4 sobre-nos-titulo">Bem-vinda ao Salão Mavih</h3>
                <p class="sobre-nos-texto">
                    O Salão Mavih atua há mais de 10 anos no mercado da beleza, oferecendo serviços com qualidade,
                    profissionalismo
                    e carinho em cada atendimento. Nossa missão é realçar a beleza natural de cada cliente, respeitando
                    seu estilo e personalidade.
                </p>
                <p class="sobre-nos-texto">
                    Trabalhamos com técnicas atualizadas, produtos de qualidade e um atendimento personalizado, sempre
                    focado no bem-estar e na satisfação de quem confia em nosso trabalho.
                    Cada detalhe é pensado para proporcionar uma experiência agradável, em um ambiente acolhedor e
                    confortável.
                </p>
                <a href="<?= base_url('cliente/Servicos_cliente') ?>"
                    class="btn btn-primary sobre-nos-btn mt-4 px-5 py-3">
    ...
    <div class="confira-servicos-header text-center my-5">
        ...
        <h1 class="fw-bold cor mb-2">Confira Todos Nossos Serviços</h1>

        <p class="text-muted mb-3">
            Nossos serviços estão cuidadosamente organizados para você encontrar o que precisa com facilidade e
            exclusividade.💖
        </p>
            ...
            <div class="row justify-content-center my-5">
                <div class="col-lg-6">
                    <div class="card nova-avaliacao shadow-lg">
                        ...
                        <h5 class="fw-bold text-center mb-3">Deixe sua Avaliação</h5>
