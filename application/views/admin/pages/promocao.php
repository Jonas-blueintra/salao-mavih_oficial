...
<div class="fade-in">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <!-- Lado esquerdo -->
        <button class="btn btn-dark" onclick="loadPage('novo_servico')">
        ...
        <div class="card-body p-4">
            <div class="form">
                <form id="formAddServicopromocao" enctype="multipart/form-data" method="post"
                    action="<?= base_url('admin/servicos/cadastrar_promocao') ?>">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="valor_antigo" class="form-control" step="0.01"
