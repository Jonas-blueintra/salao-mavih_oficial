...
///////////////////////////////////////////////////////////////////////////
@mkdir('../../../../uploads/tinymce/uploads', 0777, true);
@mkdir('../../../../uploads/tinymce/thumbs', 0777, true);
$base = str_replace("dist/assets/libs/filemanager/dialog.php", "", $_SERVER['SCRIPT_NAME']);
///////////////////////////////////////////////////////////////////////////
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => $base . 'uploads/tinymce/uploads/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../../../../uploads/tinymce/uploads/',
